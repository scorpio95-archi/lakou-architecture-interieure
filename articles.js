...
async function init(){
  ...
  if (params.get('tab') === 'mine' && session){
    state.tab = 'mine';
    document.querySelectorAll('#articleTabs .gtab').forEach(btn => {
...
function renderCard(article){
  ...
  return `
    <a href="article-detail.html?id=${article.id}" class="gallery-card gallery-card-link">
      ${coverHtml}
      <div class="gc-body">
        <div class="gc-author">
